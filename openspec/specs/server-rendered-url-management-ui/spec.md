# server-rendered-url-management-ui Specification

## Purpose
TBD - created by archiving change server-side-thymeleaf-ui-for-url-shortener. Update Purpose after archive.
## Requirements
